<template>
  <div class="slideBox" @mousemove="clearInterval" @mouseout="auto">
    ...
    <!--<transition class="fadenew">
    	<div class="slidePic" v-if="sliders!=0" v-show="!show" :style="'background-image:url(../../static/images/'+sliders[nowIndex].Url+')'"></div>
    </transition>-->
...
<style scoped>
	...
	.slideBox{position: relative;width: 100%; height: 300px;overflow: hidden; margin-bottom: 15px;}
	.slidePic{width: 100%; height: 100%; background: url(../../static/images/anta.jpg) no-repeat center center; background-size:cover;}
